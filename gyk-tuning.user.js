...
// @resource      gyk-tuning-css  https://github.com/juzraai/gyk-tuning/raw/master/gyk-tuning.css
...
// head
var css = GM_getResourceText("gyk-tuning-css");
GM_addStyle(css);

//$('head').append('<link rel="stylesheet" href="https://github.com/juzraai/gyk-tuning/raw/master/gyk-tuning.css" type="text/css" />');
...
function topic(doc) {
	$('#main').fadeOut('fast', function() {
		...
		$('h1, div', d).remove();
		$('#main').append('<h1 class="question">'+q+'</h1>');
		$('#main').append('<p class="question">'+d.html()+'</p>');

		// TODO linkek normális formára hozása, hibák javítása, amit lehet
